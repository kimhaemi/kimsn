...
public class StepTwoProcess {
    ...
    @Transactional
    public void stepTwo(String gubunStr, String siteInfo, String ipInfo) {
        String mode = DataCommon.getInfoConf("siteInfo", "mode", siteInfo, ipInfo);
        int gubun = Integer.parseInt(DataCommon.getInfoConf("siteInfo", "gubun", siteInfo, ipInfo));
        ...
        if (onoffDto.getValue() == 1) {
            stepThree(gubun, dataKindStr, srCnt, srDto, gubunStr, siteInfo, ipInfo);
        } else {
    ...
    @Transactional
    public void stepThree(int gubun, String dataKindStr, int srCnt, List<StationDto> srDto, String gubunStr, String siteInfo, String ipInfo) {

        log.info("======================= 문자 전송 =================================");

        String callFrom = DataCommon.getInfoConf("siteInfo", "call_from", siteInfo, ipInfo);
        String templateCode = DataCommon.getInfoConf("siteInfo", "template_code", siteInfo, ipInfo);
