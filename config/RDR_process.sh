...
RADAR_HOME_LIST=`ls -al  | grep 'RDR' | awk '{print $9}'`
                ...
                [Aa]ll)
                        ...
                        do
                                ...
                                else
                                {
                                        ...
                                        echo "$radar_list RDR Process Start-up."
                                }
                                fi
                        done
                ...
                [Aa]ll)
                        ...
                        do
                                ...
                                then
                                {
                                        ...
                                        kill $kill_pid;
                                    echo "$radar_list RDR Process Stop."
                                }
                                fi
                        done
                ;;
