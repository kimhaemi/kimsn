...
#RADAR_HOME=/home/watcher/deamon/SDR
#RADAR_NAMES=radardemo-SDR.jar
...
RADAR_HOME=/home/watcher/deamon/SDR
RADAR_NAMES=SDR.jar
RADAR_DAEMON_TYPE=-DDAEMON_TYPE=KMA_SDR
##################
# 사용방법
##################
# # 시작
#./SDR_process.sh start
# # 종료
#./SDR_process.sh stop
# # 프로세스 확인
#./SDR_process.sh list
...
if [ $# == 0 ]
        then echo "Usage: SDR_process.sh [start | stop | list | version]"; exit;
fi

RADAR_HOME_LIST=`ls -al  | grep 'SDR' | awk '{print $9}'`
                ...
                [Aa]ll)
                        ...
                        do
                                ...
                                then
                                {
                                        ...
                                        kill $kill_pid;
                                    echo "$radar_list SDR Process Stop."
                                }
                                fi
                        done
                ;;
