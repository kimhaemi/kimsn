...
RADAR_HOME=/home/watcher/deamon/RDR_B
RADAR_NAME_JAR=RDR_B.jar
RADAR_DAEMON_TYPE=-DDAEMON_TYPE=MCEE_RDR
RADAR_TITLE=RDR_B
...
##################
# # 시작
#./RDR_B_process.sh start
# # 종료
#./RDR_B_process.sh stop
# # 프로세스 확인
#./RDR_B_process.sh list
##################################################
...
if [ $# == 0 ]
        then echo "Usage: RDR_B_process.sh [start | stop | list | version]"; exit;
fi
